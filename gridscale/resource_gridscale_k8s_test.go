...
resource "gridscale_k8s" "foopaas" {
	...
	oidc {
		enabled = true
		issuer_url = "https://sts.windows.net/fe4ac456-23a7-4841-a404-01fcb695412c/"
		client_id = "015ad6ba-1da5-4958-be94-8d50fa37898f"
		username_claim = "email"
		groups_claim = "groups"
		groups_prefix = "oidc:"
		username_prefix = "oidc:"
		required_claim = "family_name=8944e8db-fe55-4443-aee0-16adfe637e71,given_name=c892dd1d-b324-48e6-a7da-051a96fbee37"
