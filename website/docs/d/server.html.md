...
* `user_data` - For system configuration on first boot. May contain cloud-config data or shell scripting. Supported tools are cloud-init, Cloudbase-init, and Ignition.
